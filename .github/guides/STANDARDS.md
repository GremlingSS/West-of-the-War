...
* The dlls section of tgs3.json is not designed for dlls that are purely `LIBCALL()()`ed since those handles are closed between world reboots. Only put in dlls that may have to exist between world reboots.
