...
/obj/effect/mob_spawn/human/corpse/damaged/legioninfested/Initialize(mapload)
	...
	switch(type)
		...
		if("Golem")
			mob_species = pick(list(/datum/species/golem/saturnite, /datum/species/golem/plasma, /datum/species/golem/diamond, /datum/species/golem/gold, /datum/species/golem/silver, /datum/species/golem/plasteel, /datum/species/golem/titanium, /datum/species/golem/plastitanium))
			if(prob(30))
