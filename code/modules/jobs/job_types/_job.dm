...
/datum/outfit/job/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE, client/preference_source)
	...
	if(H.special_i >= 3)
		...
		H.mind.teach_crafting_recipe(/datum/crafting_recipe/tribal_r_combat_armor)
		H.mind.teach_crafting_recipe(/datum/crafting_recipe/tribal_r_combat_armor_helmet)
	...
	if(H.special_i >= 9)
		...
		H.mind.teach_crafting_recipe(/datum/crafting_recipe/flux)
		H.mind.teach_crafting_recipe(/datum/crafting_recipe/lenses)
		H.mind.teach_crafting_recipe(/datum/crafting_recipe/conductors)
