...
/datum/quirk/social_anxiety/proc/looks_at_floor(datum/source, atom/A)
	...
	addtimer(CALLBACK(usr, GLOBAL_PROC_REF(to_chat), quirk_holder, "<span class='smallnotice'>You make eye contact with [A].</span>"), 3)
...
/datum/quirk/social_anxiety/proc/eye_contact(datum/source, mob/living/other_mob, triggering_examiner)
	...
	addtimer(CALLBACK(usr, GLOBAL_PROC_REF(to_chat), quirk_holder, "<span class='userdanger'>[msg]</span>"), 3) // so the examine signal has time to fire and this will print after
